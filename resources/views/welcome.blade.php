              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <input type="text" name="fecha" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask>
                  </div>
                  <!-- /.input group -->
                </div>
                ...
                <table class="table table-head-fixed text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$event->titulo}}</td>
                        <td><p class="text-wrap" style="width:400px;">{{$event->detalle}}</p></td>
                        <td>{{$event->lugar}}</td>
                        <td>{{ date('d-m-Y', strtotime($event->fecha))}}</td>
                        <td>{{$event->hora}}</td>
                        <td>
                          @if($event->img)
                           <button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-default" onclick="verImagenEvento('{{ url('/public/'.$event->img)}}');">Ver Imagen</button>
                          @else
                        ...
                        <td><a href="{{url('/api/deletevent/'.$event->id)}}" class="btn btn-danger">Eliminar</a> </td>
